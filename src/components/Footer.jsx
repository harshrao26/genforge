...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-[#000000] text-gray-300">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              <a
                ...
                className="inline-flex items-center justify-center rounded-md border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/90 shadow-sm transition hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500/40"
              >
                hello@genforgestudio.com
              </a>
              <a
                href="tel:+917390803067"
                className="inline-flex items-center justify-center gap-2 rounded-md border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/90 shadow-sm transition hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500/40"
              >
                <FaPhoneAlt className="h-4 w-4" />
                +91 73908 03067
              </a>
              <div className="flex items-start gap-3 mt-1">
                <div className="flex items-center justify-center h-8 w-8 rounded-md bg-white/5 border border-white/10 text-[#833DFA]">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-md bg-[#833DFA]   px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-fuchsia-500/20 transition hover:-translate-y-0.5 hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/40"
              >
                Schedule a call
              </Link>
            </div>
