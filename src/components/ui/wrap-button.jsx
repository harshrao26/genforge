    ...
    <div className="flex items-center justify-center">
      {href ? (
        <Link href={href}>
          ...
          >
            <div className="border border-[#3B3A3A] bg-[#833DFA]  h-[43px] rounded-full flex items-center justify-center text-white">
        ...
        <div
          className={cn(
            "group cursor-pointer   group   gap-2  h-[64 px] flex items-center  ",
            className
          )}
        >
          <div className="border border-[#3B3A3A] bg-[#833DFA]  h-[43px] rounded-full flex items-center justify-center text-white">
            ...
            <p className="font-medium tracking-tight mr-3">
             ...
             <div className="  mr-2  ease-in-out transition-all size-[26px] flex items-center justify-center rounded-full border-2 bor der-[#3b3a3a]  ">
            <ArrowRight
              size={18}
              className="group-hover:rotate-45 ease-in-out transition-all "
            />
